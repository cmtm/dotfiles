...
# TODO(chris): decide if we want this
...
$env.config = {
    ...
    # TODO(chris): figure out completions. Look into carapace
    completions: {
    ...
    # TODO(chris): determine if we want to change this default
    ...
    hooks: {
        # TODO(chris): see if we can use this to have command separators
        pre_prompt: [{ null }] # run before the prompt is shown
    }

    # TODO(chris): look at everything below this line
    menus: [
